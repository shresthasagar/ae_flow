...
parser.add_argument("--path", default='data/MNIST/processed', metavar="PATH", type=str, help="Path to image directory")
...
def train(args, model, optimizer):
    ...
    raw_loader = DataLoader(train_set, batch_size=args.batch, num_workers=5, shuffle=True)
    train_loader = iter(raw_loader)
